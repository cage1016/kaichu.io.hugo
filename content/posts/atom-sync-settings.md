...
{{<img src="images/posts/atom-sync-settings-02.jpg">}}
...
{{<img src="images/posts/atom-sync-settings-03.jpg">}}
...
{{<img src="images/posts/atom-sync-settings-04.jpg">}}
{{<img src="images/posts/atom-sync-settings-05.jpg">}}

#### Sync Backup

在填入 Personal Access Token 及 Gist Id 後，就可以進行同步的動作 `Shit + command + P` (Mac), `Ctrl + Shit + P` (Windows)

{{<img src="images/posts/atom-sync-settings-06.jpg">}}
{{<img src="images/posts/atom-sync-settings-07.jpg">}}

#### Sync restore

在其他電腦上裝好 Atom > 安裝 sync-settings > 進行 Sync: restore 的動作 `Shit + command + P` (Mac), `Ctrl + Shit + P` (Windows)

{{<img src="images/posts/atom-sync-settings-08.png">}}
{{<img src="images/posts/atom-sync-settings-09.png">}}
